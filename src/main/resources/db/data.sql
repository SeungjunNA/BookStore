...
INSERT INTO book (title, sub_title, price, stock, page, size, publish_date, thumbnail_url, publisher, contents, sub_category_id)
VALUES ('맨큐의 경제학', '경제학의 기본을 배우다', 47000 , 90, 1440, 'A5', 20210225, 'https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9788962185027.jpg', '한티에듀', '경제학의 기본을 배우다', 2);

INSERT INTO book (title, sub_title, price, stock, page, size, publish_date, thumbnail_url, publisher, contents, sub_category_id)
VALUES ('가여운 것들', '가여운 것들', 18000 , 190, 900, 'A5', 20230421, 'https://contents.kyobobook.co.kr/sih/fit-in/458x0/pdt/9791170522690.jpg', '황금가지', '버려진 서류 더미에서 발견된 한 권의 책, 죽음에서 부활한 여자에 얽힌 기록은 과연 진실일까?', 2);
